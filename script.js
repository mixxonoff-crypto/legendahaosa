...
const dungeonDatabase = [
    ...
    { name: "Чёрный Рыцарь", hp: 5000000, maxHp: 5000000, attack: 70000, image: "darkknight.jpg", exp: 1500000, silver: 2500000, icon: "⚔️", reqLvl: 53, qText: "Мрачное подземелье", qClass: "q-dark" },
...
activePlayer.maxEnergy += 100; 
    ...
    if (levelUpOccurred) { 
        // Восстанавливаем текущее ХП до нового максимума
